...
/**
 * Servlet implementation class AdminServicoProvas
 */
@WebServlet("/AdminServicoProvas")
public class AdminServicoProvas extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public AdminServicoProvas() {
        super();
		...
		if(opcao.equals("Inscrever")){
			...
			if(nivel == false){
				...
				if(verificaPro == false){
					...
					response.setContentType("text/html");  
					out.println("<script type=\"text/javascript\">");  
					out.println("alert('Erro: Inscreva na respetiva modalidade primeiro!');");
					out.println("location='administracaoA.html';");
					out.println("</script>");
				}else{
